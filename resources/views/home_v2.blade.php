...
<style>
    ...
    .btn-hero-primary:hover {
        ...
        box-shadow: 0 0 50px rgba(249,115,22,.55);
        color: #fff;
    }
    ...
    .hero-ip-label { font-size: .7rem; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: rgba(255,255,255,.4); }
    .hero-ip-value { font-size: 1rem; font-weight: 700; color: #fff; font-family: monospace; letter-spacing: .05em; }
    .hero-ip-copy { font-size: .7rem; color: #fb923c; font-weight: 600; letter-spacing: .05em; }
    ...
    .scroll-hint span { font-size: .7rem; color: #fff; letter-spacing: .1em; text-transform: uppercase; }
    @keyframes bounce {
...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <div class="hero-actions">
            <a href="/actualites" class="btn-hero-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z"/>
                </svg>
                Voir les actualités
            </a>
            <a href="/qui_sommes_nous" class="btn-hero-secondary">
                En savoir plus
        ...
        {{-- Statut serveur --}}
        <div class="hero-ip" style="cursor:default;">
            ...
            <div>
                <div class="hero-ip-label">Statut actuel</div>
                <div class="hero-ip-value" style="font-family:inherit; font-size:.95rem;">Serveur en pause · Saison 7 bêta en cours</div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-lg">
                <div class="feature-card">
                    ...
                    <p class="feature-title">Haute Collab</p>
                    <p class="feature-desc">Travaille avec la communauté pour bâtir plus grand.</p>
                </div>
            </div>
            ...
            <div class="col-6 col-lg">
                <div class="feature-card">
                    ...
                    <p class="feature-title">Staff actif</p>
                    <p class="feature-desc">Une équipe disponible pour assurer le bon jeu.</p>
                </div>
            </div>
            ...
            <div class="col-6 col-lg">
                <div class="feature-card">
                    ...
                    <p class="feature-title">Mods</p>
                    <p class="feature-desc">Des modifications soigneusement sélectionnées.</p>
                </div>
            </div>
            ...
            <div class="col-6 col-lg">
                <div class="feature-card">
                    ...
                    <p class="feature-desc">Des événements réguliers pour animer le serveur.</p>
                </div>
            </div>
            ...
            <div class="col-6 col-lg">
                <div class="feature-card">
                    ...
                    <p class="feature-title">Monnaie Unique</p>
                    <p class="feature-desc">Un système économique cohérent et équilibré.</p>
                </div>
            </div>
...
<section class="about-section">
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-5">
                <p class="about-label">Le serveur</p>
                <h2 class="about-title">Découvre<br>SpaziaEco</h2>
                <p class="about-text">
                ...
                <a href="/launcher_spaziacraft" class="btn-hero-primary mt-4" style="display:inline-flex;">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="article-card">
                    ...
                    <div class="article-body">
                        ...
                        <a href="{{ $article->lien_pubhtml5 }}" target="_blank" rel="noopener" class="article-link">
                            Voir l'article
...
<style>
    ...
    .rc-pfp img { width: 100%; height: 100%; object-fit: cover; border-radius: 8px; }
    .rc-texts   { overflow: hidden; flex: 1; }
    .rc-title   { color: #fff; font-size: 13px; font-weight: 700; margin: 0 0 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .rc-artist  { color: rgba(255,255,255,.5); font-size: 11px; margin: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }

    /* Ligne 2 — barre de progression */
    .rc-progress { display: flex; align-items: center; gap: 8px; }
    .rc-time     { color: rgba(255,255,255,.4); font-size: 10px; min-width: 30px; font-variant-numeric: tabular-nums; }
    .rc-time:last-child { text-align: right; }
    .rc-bar  { flex: 1; height: 4px; background: #3a3a3a; border-radius: 2px; overflow: hidden; }
    .rc-fill { height: 100%; width: 0%; background: #1db954; border-radius: 2px; transition: width 1s linear; }

    /* Ligne 3 — contrôles */
    .rc-controls { display: flex; align-items: center; justify-content: space-between; }
    .rc-vol-wrap { display: flex; align-items: center; gap: 6px; flex: 1; }
    .rc-btn {
        background: none; border: none; padding: 0;
        cursor: pointer; color: rgba(255,255,255,.6);
        line-height: 0; transition: color .15s;
...
<div class="radio-card">
    ...
    <div class="rc-top">
        ...
        <div class="rc-texts">
            <p class="rc-title"  id="radio-title">SpaziaRadio</p>
            <p class="rc-artist" id="radio-artist">Chargement...</p>
        </div>
    </div>

    {{-- Ligne 2 : progression --}}
    <div class="rc-progress">
        <span class="rc-time" id="rc-now">0:00</span>
        <div class="rc-bar"><div class="rc-fill" id="rc-fill"></div></div>
        <span class="rc-time" id="rc-total">0:00</span>
    </div>

    {{-- Ligne 3 : contrôles --}}
    <div class="rc-controls">
        <div class="rc-vol-wrap">
        ...
        <button class="rc-btn" style="flex:1;justify-content:flex-end;">
...
<script>
    ...
    function setPlaying(playing) {
        ...
        if (playing) startTicker(); else clearInterval(rcTicker);
    }
    ...
    async function fetchNowPlaying() {
        try {
            ...
            document.getElementById('radio-title').textContent  = song?.title  || 'SpaziaRadio';
            document.getElementById('radio-artist').textContent = song?.artist || 'SpaziaRadio';
            ...
            if (song?.art) pfp.innerHTML = `<img src="${song.art}" alt="cover">`;
